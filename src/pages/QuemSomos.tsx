...
export default function QuemSomos() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#4A90A9] to-[#5EA98D] text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex items-center justify-center mb-6">
            <div className="p-6 bg-white/20 backdrop-blur-sm rounded-full shadow-2xl animate-pulse">
      ...
      <div className="container mx-auto px-4 py-16 space-y-20">
        ...
        <div>
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-[#4A90A9] via-[#5EA98D] to-[#CFAF5A]"></div>
            ...
            <div className="space-y-1" data-json-key="quemsomos.historico.content.map">
              {texts.historico.content.map((paragraph: string, index: number) => (
                <div key={index} className={`flex items-center gap-2 ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  ...
                  <div className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-[#4A90A9] to-[#5EA98D] rounded-full border-4 border-white shadow-lg z-10 relative">
              ...
              <Card key={index} className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-t-4 border-t-[#5EA98D]">
                <CardHeader>
                  <div className="flex items-center gap-4 mb-2">
                    <div className="p-3 bg-gradient-to-r from-[#4A90A9] to-[#5EA98D] rounded-lg text-white group-hover:scale-110 transition-transform">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-[#CFAF5A]/10 to-[#B89B4A]/10 rounded-3xl blur-3xl"></div>
          <Card className="relative bg-gradient-to-br from-[#CFAF5A] via-[#B89B4A] to-[#8B7635] text-white border-none shadow-2xl overflow-hidden">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-6" data-json-key="quemsomos.hermeticos.items.map">
            {texts.hermeticos.items.map((item: { number: string; title: string; description: string }, index: number) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-r ${hermeticosCores[index].gradient} rounded-2xl blur opacity-25 group-hover:opacity-50 transition-opacity`}></div>
                <div className={`relative flex gap-6 items-start p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all border-l-4 ${hermeticosCores[index].border} group-hover:border-[#CFAF5A]`}>
                  <div className="flex-shrink-0">
                    <div className="relative">
                      <div className={`w-16 h-16 bg-gradient-to-br ${hermeticosCores[index].gradient} rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}>
