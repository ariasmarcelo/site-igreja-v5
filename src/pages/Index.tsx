...
export default function Index() {
  ...
  usePageStyles('index'); // Carregar estilos CSS customizados
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#FAF9F7] via-[#F5F3F0] to-[#E8E6E3]">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-[#CFAF5A] to-[#B38938] rounded-3xl transform rotate-3"></div>
                <Card className="relative bg-white shadow-2xl rounded-3xl overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-[#CFAF5A] to-[#B38938] text-white p-8">
                    <CardTitle 
                    ...
                    <div className="space-y-4" data-json-key="index.purification.phases.map">
                      {safeTexts.purification.phases.map((phase, index) => (
                        <div key={index} className="flex items-start gap-3">
                          <div 
                            className="w-8 h-8 rounded-full bg-[#CFAF5A] bg-opacity-20 flex items-center justify-center flex-shrink-0 mt-1"
      ...
      <section className="py-20 bg-gradient-to-br from-[#F5F3F0] to-[#E8E6E3]">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 relative">
                <div className="absolute inset-0 bg-gradient-to-br from-[#4A90A9] to-[#3a7089] rounded-3xl transform -rotate-3"></div>
                <Card className="relative bg-white shadow-2xl rounded-3xl overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-[#4A90A9] to-[#5EA98D] text-white p-8">
                    <CardTitle 
                        ...
                        <div className="space-y-3" data-json-key="index.instituto.treatments.map">
                          {safeTexts.instituto.treatments.map((treatment: string, index: number) => (
                            <div key={index} className="flex items-center gap-3">
                              <Heart 
                                className="w-5 h-5 text-[#5EA98D] flex-shrink-0"
              ...
              <div className="order-1 md:order-2 fade-in">
                ...
                >
                  <Button 
                    className="bg-gradient-to-r from-[#4A90A9] to-[#5EA98D] text-white font-semibold px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105" data-json-key="index.instituto.ctaButton">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-[#FAF9F7] to-[#F5F3F0]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-blue-600 to-amber-600 bg-clip-text text-transparent px-4" data-json-key="index.fisicoEspiritual.title">
                  ...
                  <ul className="space-y-2 sm:space-y-3 ml-2" data-json-key="index.fisicoEspiritual.fisico.items.map">
                    {safeTexts.fisicoEspiritual.fisico.items.map((item: string, idx: number) => (
                      <li key={idx} className="flex items-start gap-2 sm:gap-3">
                        <span className="text-blue-500 mt-1 text-base sm:text-lg flex-shrink-0">•</span>
                ...
                <div className="space-y-4 sm:space-y-6 text-gray-700">
                  ...
                  <ul className="space-y-2 sm:space-y-3 ml-2" data-json-key="index.fisicoEspiritual.espiritual.items.map">
                    {safeTexts.fisicoEspiritual.espiritual.items.map((item: string, idx: number) => (
                      <li key={idx} className="flex items-start gap-2 sm:gap-3">
                        <span className="text-amber-500 mt-1 text-base sm:text-lg flex-shrink-0">•</span>
                        <span className="text-sm sm:text-base" dangerouslySetInnerHTML={{ __html: item.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>') }} />
                      </li>
                    ))}
                  </ul>
          ...
          {/* Abordagem Integrada */}
          <Card className="border-purple-300 shadow-2xl bg-gradient-to-br from-purple-50/50 via-amber-50/50 to-blue-50/50 -mt-6 sm:-mt-10">
            <CardContent className="pt-8 sm:pt-10 pb-8 sm:pb-10 px-6 sm:px-10">
              ...
              <div className="space-y-4 sm:space-y-6 text-gray-700 max-w-4xl mx-auto" data-json-key="index.fisicoEspiritual.integrada.description.replace">
                ...
                <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-amber-50 p-6 sm:p-8 rounded-lg border-2 border-purple-300 mt-6 sm:mt-8">
                  ...
                  <ul className="space-y-3 sm:space-y-4" data-json-key="index.fisicoEspiritual.integrada.oferecemos.items.map">
                    {safeTexts.fisicoEspiritual.integrada.oferecemos.items.map((item: string, idx: number) => (
                      <li key={idx} className="flex items-start gap-3 sm:gap-4">
                        <Database className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600 flex-shrink-0 mt-0.5" />
                        <span className="text-sm sm:text-base" dangerouslySetInnerHTML={{ __html: item.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>') }} />
                      </li>
                    ))}
                  </ul>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-10" data-json-key="index.triplaProtecao.items.map">
            {safeTexts.triplaProtecao.items.map((item: { title: string; description: string }, idx: number) => {
              ...
              return (
                <Card key={idx} className={`border-${color}-300 shadow-xl hover:shadow-2xl transition-all bg-gradient-to-br from-${color}-50/50 to-white`}>
                  <CardContent className="pt-8 sm:pt-10 pb-8 sm:pb-10 px-6 sm:px-8">
                    <div className="text-center mb-6 sm:mb-8">
      ...
      {/* CTA Final Section */}
      <section className="py-20 bg-gradient-to-r from-[#CFAF5A] to-[#B38938] text-white">
        <div className="container mx-auto px-4">
