...
$logFile = 'C:\temp\Site_Igreja_Meta\V5_SiteIgreja\workspace\shadcn-ui\logs\deploy-20251110-045841.log'
...
Write-Log "Mensagem: test: modo background unificado"
...
try {
    ...
    $gitCommitOutput = git commit -m "test: modo background unificado" 2>&1 | Out-String
