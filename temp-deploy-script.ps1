...
$logFile = 'C:\temp\Site_Igreja_Meta\V5_SiteIgreja\workspace\shadcn-ui\logs\deploy-20251110-050957.log'
...
Write-Log "Mensagem: feat: alias -b confirmado e docs atualizados"
...
try {
    ...
    $gitCommitOutput = git commit -m "feat: alias -b confirmado e docs atualizados" 2>&1 | Out-String
